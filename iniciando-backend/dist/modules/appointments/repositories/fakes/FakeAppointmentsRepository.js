...
class AppointmentsRepository {
  ...
  async findByDate(provider_id, date) {
    const findAppoiment = this.appointments.find(appointment => (0, _dateFns.isEqual)(appointment.date, date) && appointment.provider_id === provider_id);
