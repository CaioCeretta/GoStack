...
let SendForgottenPasswordEmailService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const forgottenPasswordTemplate = _path.default.resolve(__dirname, '..', 'views', 'forgot_password.hbs');
...
var _default = SendForgottenPasswordEmailService;
