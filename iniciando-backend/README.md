...
- Usuário deve conseguir atualizar seu email e senha;
...
- O usuário não pode alterar se ue-mail para um e-mail já utilizado;
...
- O usuário deve poder realizar um noo
...
- Os agendamentos devem estar disponíveis entre 8h da manhã e 18h (Primeiro às 8h, último às 7h);
